...
describe("Challenge 2 Tests", () => {
  test("basic tests", () => {
    ...
    expect(filterArray([16, "op", 20, "[[", 24, 26, "yy"])).toEqual([
      16, 20, 24, 26,
    ]);
...
describe("Challenge 4 Tests", () => {
  test("basic tests", () => {
    ...
    expect(sumTwoSmallestNums([10, 343445353, 3453445, 3453545353453])).toBe(
      3453455
    );
    ...
    expect(sumTwoSmallestNums([3683, 2902, 3951, -475, 1617, -2385])).toBe(
      4519
    );
